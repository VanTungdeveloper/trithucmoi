    ...
    return (
        ...
        <div>
            <div className="App">
                ...
                <div className="infomation">
                    <button type="button" className="btn btn-default" onClick={() => {navigate("add");}}> + Add New Product </button>
                </div>
            </div>
        <Table dataSource={dataSource}>
            ...
            <Column title="Category" key="categoryId" 
                render={(_, record) => (   
                    <Space size="middle">
                        {dataSourceCate.map((dataCate)=>
